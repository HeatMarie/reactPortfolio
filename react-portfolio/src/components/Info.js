    ...
    <div className="container">
        <div className="row">
            ...
            <div className="col-6">
                ...
                <br></br>                
                <p>Back when I was 14 years old, I pulled my Papa's C++ book off the bookshelf and opened it to the first chapter, the simple "Hello World". I struggled, of course, I did. My attention span was a max of -1 and so was my self confidence. I struggled with what every coder and programmer in the world has strugled with, our archnemesis; the semicolon. If I would have known then that I was not the only human in the world who fought for dhours over one small semicolon my life would have been different. I wouldn't have waited so long to begin my journey.</p>
                <br></br>
                <p>
