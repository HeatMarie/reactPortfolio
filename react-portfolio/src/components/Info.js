    ...
    <div className="container">
        <div className="row info-content-container">
            ...
            <div className="col-6 infoIntro">
                ...
                <br></br>
                <p>
                    So, here I am, making amends and proving my 14 year old self wrong!
                </p>
                <br></br>
                <p> 
                    Each step I take may be small, but it is taking me down a path to a career that I will enjoy. I was told to always remember that enjoyment, and I made a promise that I will. And I don't break promises. 
                </p>
            </div>
            <hr></hr>
        </div>
